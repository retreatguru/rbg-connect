<div class="card" style="margin-top: 0; max-width: 1000px; margin-right: 20px;">
    ...
    <p>Program extra display fields can be accesses using <code>extra_display_field="My Title"</code> where "My Title" is the exact title of the extra display field as set when editing the program.
    </p>
    ...
    <p>For websmasters and site developers who want to position a program list that can't be done through editing a post, page or widget, you can also implement this shortcode in a theme file using
